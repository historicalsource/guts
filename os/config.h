...
#define DYNAMIC_PIXEL_CLOCK (1)
#define DYNAMIC_GAMMA_CORRECTION (1)
#define NO_FRBIT (0)	/* Allow the FR bit */
#define SQUAWK_ON_EXCEPT (0)
#define TIME_EXCEPTIONS (0)
#define BOOT_COPY_SELF (1)
#define BOOT_FROM_DISK (1)
#define NO_NMI_DETECTION (1)
#define NO_EXIT_FUNC (1)
#define NO_AUTO_TEST_MENU (1)
#define NO_EER_WRITE (1)	/* Disable BRAM updates */
#define NO_BRAM_AUS (1)
#define NO_WDOG (1)
#define NO_ROM_TEST_MENU (1)
#define ANNOUNCE_BOOT_ACTIONS (1)
#define SMC_SA_TESTS (1)
#define SA_DIAGS (1)
...
#define QIO_POOL_SIZE (524288)	/* QIO and FSYS use this area. */
#define JUNK_POOL_SIZE (-1)	/* Use all available space for malloc et al */
...
#define IDE_RW_VIA_DMA (1)	/* Allow DMA r/w */
#define ICELESS_IO (0)
...
#define DRAM_BANKS (1)	/* Defaults to 1 banks of DRAM */
...
#define IO_DIPSW (0x0B6000000)	/* bits 15:0 (ro) = dip switches */
#define IO_DIPSW_T (*(VU16*)(0x0B6000000))	/* bits 15:0 (ro) = dip switches */
#define IO_DIPSW0 (0x1)	/* dip switch 0 */
#define IO_DIPSW1 (0x2)	/* dip switch 1 */
#define IO_DIPSW2 (0x4)	/* dip switch 2 */
#define IO_DIPSW3 (0x8)	/* dip switch 3 */
#define IO_DIPSW4 (0x10)	/* dip switch 4 */
#define IO_DIPSW5 (0x20)	/* dip switch 5 */
#define IO_DIPSW6 (0x40)	/* dip switch 6 */
#define IO_DIPSW7 (0x80)	/* dip switch 7 */
#define IO_DIPSW8 (0x100)	/* dip switch 8 */
#define IO_DIPSW9 (0x200)	/* dip switch 9 */
#define IO_DIPSW10 (0x400)	/* dip switch 10 */
#define IO_DIPSW11 (0x800)	/* dip switch 11 */
#define IO_DIPSW12 (0x1000)	/* dip switch 12 */
#define IO_DIPSW13 (0x2000)	/* dip switch 13 */
#define IO_DIPSW14 (0x4000)	/* dip switch 14 */
#define IO_DIPSW15 (0x8000)	/* dip switch 15 */
#define IO_MISC (0x0B6000004)	/* bits 15:0 (ro) = misc inputs */
#define IO_MISC_T (*(VU16*)(0x0B6000004))	/* bits 15:0 (ro) = misc inputs */
...
#define IO_PLAYER_21 (0x0B6000008)	/* bits 15:0 (ro) = player 1 and player 2 inputs */
#define IO_PLAYER_21_T (*(VU16*)(0x0B6000008))	/* bits 15:0 (ro) = player 1 and player 2 inputs */
...
#define IO_PLAYER_43 (0x0B600000C)	/* bits 15:0 (ro) = player 3 and player 4 inputs */
#define IO_PLAYER_43_T (*(VU16*)(0x0B600000C))	/* bits 15:0 (ro) = player 3 and player 4 inputs */
...
#define IO_UART_CTL (0x0B6000010)	/* bits 15:0 (rw) = UART control bits */
#define IO_UART_CTL_T (*(VU16*)(0x0B6000010))	/* bits 15:0 (rw) = UART control bits */
...
#define IO_UART_TX (0x0B6000014)	/* bits  7:0 (rw) = UART transmit register */
#define IO_UART_TX_T (*(VU16*)(0x0B6000014))	/* bits  7:0 (rw) = UART transmit register */
#define IO_UART_RCV (0x0B6000018)	/* bits 15:0 (ro) = UART receive/status registers */
#define IO_UART_RCV_T (*(VU16*)(0x0B6000018))	/* bits 15:0 (ro) = UART receive/status registers */
...
#define IO_METER (0x0B600001C)	/* bits  4:0 (rw) = meter control register */
#define IO_METER_T (*(VU16*)(0x0B600001C))	/* bits  4:0 (rw) = meter control register */
...
#define IO_H2MIC_CMD (0x0B6000030)	/* bits  3:0 (rw) = Host to microcontroller control */
#define IO_H2MIC_CMD_T (*(VU16*)(0x0B6000030))	/* bits  3:0 (rw) = Host to microcontroller control */
#define IO_MIC2H_DTA (0x0B6000034)	/* bits  7:0 (ro) = MIC to host data register */
#define IO_MIC2H_DTA_T (*(VU16*)(0x0B6000034))	/* bits  7:0 (ro) = MIC to host data register */
...
#define NSS_BASE (0x0B6800000)
#define NSS_CTL (0x0B6800000)	/* bits 15:0 (rw) = NSS control register */
#define NSS_GAME_CTL (0x0B6800004)	/* bits 15:0 (ro) = NSS game control register */
#define NSS_FIFO_STS (0x0B6800008)	/* bits 15:0 (ro) = NSS FIFO status */
#define NSS_GAMEINT (0x0B680000C)	/* bits 15:0 (ro) = NSS Game interrupt status */
#define NSS_FIFO_DTA (0x0B6800010)	/* bits 15:0 (rw) = NSS read/write FIFO */
#define NSS_FIFO_RST (0x0B6800014)	/* bits 15:0 (wo) = NSS FIFO reset register */
#define WB_BASE (0x0B6C00000)	/* Widget Board, has RDY ( alias of NSS_BASE ) */
...
#define B_GPSTS_NSS (1)	/* NSS interrupt */
...
#define B_RESET_NSS (0x4)	/*	bit 4 = NSS reset */
...
#define EXP_LVL (0x7)
#define B_PIC_EXP (0)	/* Phoenix Interrupt Control */
#define EXP_NOTES (0x1)
#define NSS_LVL (0x6)
#define B_PIC_NSS (1)	/* Phoenix Interrupt Control */
#define NSS_NOTES (0x2)
#define DBG_LVL (0x7)
#define B_PIC_DBG (6)	/* Phoenix Interrupt Control */
#define DBG_NOTES (0x40)
#define VSY_LVL (0x5)
#define B_PIC_VSY (7)	/* Phoenix Interrupt Control */
...
#define INTCTL_MAPA_INIT (0x700B)	/* Phoenix Interrupt Map Register */
#define PHOENIX_INTCTL_MASK (0x0C3)	/* Phoenix Interrupt Control */
#define GALILEO_INTCTL_MASK (0x810)	/* Galileo Interrupt Control */
...
#define WB_ADR (0x0B6C00000)	/* Address Register */
#define WB_INT (0x0B6C00004)	/* Interrupt Register */
#define WB_LED (0x0B6C00008)	/* LED Register */
#define WB_AUX (0x0B6C0000C)	/* Wheel Driver Register */
#define WB_A2D (0x0B6C00010)	/* A to D Converter */
#define WB_ETH (0x0B6C00014)	/* Ethernet Controller */
#define WB_NSS (0x0B6C00018)	/* NSS Board */
#define WB_RST (0x0B6C0001C)	/* Reset Register */
#define B_WBINT_A2D (0x0)	/* Bit 0 -- A/D Interrupt */
#define B_WBINT_NSS (0x1)	/* Bit 1 -- NSS Interrupt */
#define B_WBINT_ETH (0x2)	/* Bit 2 -- ETH Interrupt */
#define M_WBINT_A2D (0x1)	/* Bit 0 -- A/D Interrupt */
#define M_WBINT_NSS (0x2)	/* Bit 1 -- NSS Interrupt */
#define M_WBINT_ETH (0x4)	/* Bit 2 -- ETH Interrupt */
#define B_WBRST_AUX (0x0)	/* Bit 0 -- A/D Reset */
#define B_WBRST_NSS (0x1)	/* Bit 1 -- NSS Reset */
#define B_WBRST_ETH (0x2)	/* Bit 2 -- ETH Reset */
#define M_WBRST_AUX (0x1)	/* Bit 0 -- A/D Reset */
#define M_WBRST_NSS (0x1)	/* Bit 1 -- NSS Reset */
#define M_WBRST_ETH (0x1)	/* Bit 2 -- ETH Reset */

#define VMDVR_WHEEL (0x4)
#define VMDVR_LAMPS (0x5)
#define M_VMDVR_DATA (0x0FF)
#define M_VMDVR_SETUP_HOLD (0x0FF00)
#define M_VMDVR_ADDR_STROBE (0x0F700)
#define M_VMDVR_DATA_STROBE (0x0FB00)
#define ICELESS_LVL (7)	/* bit within control register + 1 */
#define UART_LVL (3)	/* Turn on the I/O ASIC UART interrupt code */
#define SND_LVL (3)	/* Turn on the I/O ASIC AUDIO interrupt code */
#define XBUS_BASE (0x0B0000000)	/* XBUS i/f board */
#define RAMROM_BASE (0x0B0400000)	/* RamRom board starts here (slot 1) */
#define INPUTS (*(VU16*)(0x0B6000008))
#define EXTEND (*(VU16*)(0x0B600000C))
#define MISC (*(VU16*)(0x0B6000004))
#define DIAG (*(VU16*)(0x0B6000000))
#define TEST (*(VU16*)(0x0B6000004))
#define B_TEST (0x4)
#define SH_INPUTS (0x0)
#define SH_EXTEND (0x10)
#define SH_MISC (0x0)
#define SH_DIAG (0x10)
...
#define SW_OPT0 (0x10000)
#define SW_OPT1 (0x20000)
#define SW_OPT2 (0x40000)
#define SW_OPT3 (0x80000)
#define SW_OPT4 (0x100000)
#define SW_OPT5 (0x200000)
#define SW_OPT6 (0x400000)
#define SW_OPT7 (0x800000)
#define SW_OPT8 (0x1000000)
#define SW_OPT9 (0x2000000)
#define SW_OPT10 (0x4000000)
#define SW_OPT11 (0x8000000)
#define SW_OPT12 (0x10000000)
#define SW_OPT13 (0x20000000)
#define SW_OPT14 (0x40000000)
#define SW_OPT15 (0x80000000)
#define SW_BITS (0x0FFFFFFFF)
#define SW_COIN1 (0x1)
#define SW_COIN2 (0x2)
#define SW_P1START (0x4)
#define SW_TILT (0x8)
#define SW_TEST (0x10)
#define SW_P2START (0x20)
#define SW_CREDIT (0x40)
#define SW_COIN3 (0x80)
#define SW_COIN4 (0x100)
#define SW_P3START (0x200)
#define SW_P4START (0x400)
#define SW_VOLM (0x800)
#define SW_VOLP (0x1000)
#define SW_UNUSED0 (0x2000)
#define SW_INTER (0x4000)
#define SW_BILL (0x8000)
#ifndef IO_METER_T
...
#define J2_UP (0x100)
#define J2_DOWN (0x200)
#define J2_LEFT (0x400)
#define J2_RIGHT (0x800)
#define J3_UP (0x10000)	/* SW07 */
#define J3_DOWN (0x20000)	/* SW06 */
#define J3_LEFT (0x40000)	/* SW05 */
#define J3_RIGHT (0x80000)	/* SW04 */
#define J4_UP (0x1000000)
#define J4_DOWN (0x2000000)
#define J4_LEFT (0x4000000)
#define J4_RIGHT (0x8000000)
#define J_UP (0x1010101)
#define J_DOWN (0x20202)
#define J_LEFT (0x40404)
#define J_RIGHT (0x80808)
#define J1_VERT (0x3)
#define J1_BITS (0x0F)
#define J2_VERT (0x300)
#define J2_BITS (0x0F00)
#define J3_VERT (0x30000)
#define J3_BITS (0x0F0000)
#define J4_VERT (0x3000000)
#define J4_BITS (0x0F000000)
#define JOY_BITS (0x10F0F0F)
#define JOY_VERT (0x1030303)
#define P1_START (0x4)
#define P2_START (0x20)
#define P3_START (0x200)
#define P4_START (0x400)
#define P1_A (0x10)
#define P1_B (0x20)
#define P1_C (0x40)
#define P1_D (0x80)
...
#define P2_C (0x4000)
#define P2_D (0x8000)
#define P3_A (0x100000)
#define P3_B (0x200000)
#define P3_C (0x400000)
#define P3_D (0x800000)
#define P4_A (0x10000000)
#define P4_B (0x20000000)
#define P4_C (0x40000000)
#define P4_D (0x80000000)
#define SW_NEXT (0x1010)	/* Player A */
#define SW_ACTION (0x2020)	/* Player B */
#define SW_EXTRA (0x4040)	/* Player C */
#define JOY_ALL (0x10F3F3F)
#define SW_ALL (0x7070)
#define SW_BITS (0x0FFFFFFFF)
#define LA_START (0x1)
#define LA_VIEW1 (0x2)
#define LA_VIEW2 (0x4)
#define LA_VIEW3 (0x8)
#define LA_WINNER (0x40)
#define LA_LEADER (0x80)
#define POT_CNT (0x8)
#define AD_PORTS_ADDR (0x0B6C00010)	/* pots.c uses this symbol */
#define POT_WHEEL (0x0)	/* Pot wheel index */
#define POT_GAS (0x1)	/* Pot gas index */
#define POT_BRAKE (0x2)	/* Pot brake index */
#define POT_WHEN_OK (1)	/* Only touch pots when GUTS says it's ok */
